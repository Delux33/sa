...
public class ProductController {
    ...
    @ApiResponses(
            value = {
                    @ApiResponse(
                            responseCode = Constants.StatusCode.OK_200_STR, description = "Продукты найдены",
                            content = {
                                    @Content(
    ...
    @ApiResponses(
            value = {
                    @ApiResponse(
                            responseCode = Constants.StatusCode.OK_200_STR, description = "Продукт найден",
                            content = {
                                    @Content(
                                            mediaType = MediaType.APPLICATION_JSON_VALUE,
                                            schema = @Schema(implementation = Product.class)
    ...
    @ApiResponses(
            value = {
                    @ApiResponse(
                            responseCode = Constants.StatusCode.OK_200_STR, description = "Продукт успешно обновлен",
                            content = {
                                    @Content(
                                            mediaType = MediaType.APPLICATION_JSON_VALUE,
                                            schema = @Schema(implementation = Product.class)
